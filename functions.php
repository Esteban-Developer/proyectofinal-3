...
function addCart()
{
    ...
    if (isset($_GET['add_cart'])) {
        ...
        if (mysqli_num_rows($run_check) > 0) {
            ...
            echo "<script>alert('Producto agregado al Carrito. Continúa Comprando.')</script>";
...
function getWProduct()
{
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        <div class='pi-pic' style='max-height:300px'>
            ...
            <ul>
                <li class='quick-view'><a href='product.php?product_id=$products_id' style='background:#fe4231;color:white'>Ver Detalles</a></li>
            </ul>
        </div>
        <div class='pi-text'>
        ...
        if ($count == 0) {
            ...
            echo "
                <div class='card' style='font-weight:bold; color:#fe4231'>
                    <div class='card-body'>No hay Productos Disponibles</div>
                </div>
...
function getProd()
{
    ...
    <div class='col-lg-6'>
        <div class='product-details'>
            ...
            <div class='pd-desc'>
                <p>$product_desc</p>
                <h4>COP $product_price</h4>
            </div>

            <ul class='pd-tags'>
                <li><span>CATEGORÍA</span>: $p_cat_name</li>
            </ul>
        ...
        <div class='col-lg-3 col-sm-6'>
            <div class='product-item' >
                <div class='pi-pic' style='max-height:300px'>
                    ...
                    <ul>
                        <li class='quick-view'><a href='product.php?product_id=$p_id' style='background:#fe4231;color:white'>Ver Detalles</a></li>
                    </ul>
                </div>
                <div class='pi-text'>
                    <a href='#'>
...
function cart_items()
{
    ...
    <div class='card col-md-3 col-10' style='margin:0 auto; border-radius:25px 5px;box-shadow: inset -12px -8px 40px #e5e5e5;'>
        <div class='card-body'>
           <h5 style='text-align:center;font-weight:500'> No hay artículos en el Carrito </h5>
        </div>
    </div>
        ...
        <tr style='border-bottom: 0.5px solid #ebebeb'>
           ...
           <td class='p-price first-row'>COP $pro_price</td>
           ...
           <td class='total-price first-row'>COP $pro_total_p</td>
...
function cart_icon_prod()
{
    ...
    if (mysqli_num_rows($run_items) == 0) {
        ...
        <p style='text-align:center; font-weight:500;color:#fe4231'>Carrito Vacío </p>
