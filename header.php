...
<title>Inferno Colombia prueba</title>
                            ...
                            <div class="login-hover">
                                <div class="insidelog">
                                    ...
                                    <?php if ($_SESSION['customer_email'] == 'unset') {
                                        echo "<a href='login.php' class='btn logbtn' style='width: 200px; height:40px'>Iniciar sesión</a>";
                                    } else {
                                        echo "<a href='logout.php' class='btn logbtn' style='width: 200px; height:40px'>Cerrar sesión</a>";
                                    } ?>

                                </div>
                                <?php if ($_SESSION['customer_email'] == 'unset') {
                                    echo "<div class='insidelog'>
                                    <span class='small'>o </span><a href='register.php' class='small'>Regístrate ahora</a>
                                </div>";
                                } ?>
                                <?php if (!($_SESSION['customer_email'] == 'unset')) {
                                    echo "
                                <div class='insidelog' style='border-top: solid 0.2px #e5e5e5;'>
                                    <a href='account.php?orders' class='btn btn-dark' style='color:white;margin:4px 0'>Mi cuenta</a>
                                </div>";
                                }
                                ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <form method="post">
                            <div class="input-group">
                                <input type="text" name="search" placeholder="Busca en nuestra tienda" required>
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                    ...
                                    <div class="select-total">
                                        <span>Total:</span>
                                        <h5><?php total_price(); ?> COP</h5>
                                    </div>
                                    <div class="select-button">
                                        <a href="shopping-cart.php" class="primary-btn view-card">Ver todos los productos</a>
                                        <a href="check-out.php" class="primary-btn checkout-btn">Ir a pagar</a>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="nav-item">
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li class="<?php if ($active == 'Home') echo 'active' ?>"><a href="index.php">Inicio</a></li>
                        <li class="<?php if ($active == 'Shop') echo 'active' ?>"><a href="shop.php">Tienda</a></li>
                        <li class="<?php if ($active == 'Contact') echo 'active' ?>"><a href="contact.php">Contacto</a></li>
                    </ul>
                </nav>
